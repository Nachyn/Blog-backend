        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoadedUtc = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_PostFiles_Path", x => x.Path);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiryTimeUtc = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_UserPhotos_Path", x => x.Path);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarPhotoId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "77d923fc-10ff-46cb-a02c-3e7cae4ac419", "admin", "ADMIN" },
                    { 2, "cfd8eff8-8f53-4c27-a3ad-90480d1bb38c", "user", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AvatarPhotoId",
                table: "AspNetUsers",
